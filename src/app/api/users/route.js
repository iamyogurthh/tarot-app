...
import { getDataFromForm, getNumerology } from '@/utils/utils.server'
import { getZodiacSign } from '@/utils/utils.server'
...
export async function POST(req) {
  ...
  if (!readingId) {
    return Response.json({
      message: 'User cannot be created and cannot be read',
    })
  }
